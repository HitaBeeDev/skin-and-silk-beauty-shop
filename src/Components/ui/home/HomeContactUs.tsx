  ...
  return (
    <section className="mt-10 grid gap-4 md:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
      <div className="rounded-[1.1rem] bg-[#4e060f] p-7 text-[#fff4f4] sm:p-9">
        ...
        <p className="mt-3 max-w-[28rem] font-['Playfair_Display',serif] text-[2rem] font-[400] leading-none sm:text-[2.4rem]">
          Need help choosing the right ritual or placing an order?
        </p>

        <p className="mt-4 max-w-[30rem] text-[0.92rem] font-[300] leading-[1.8] text-[#ffe4e9]">
      ...
      <div className="grid gap-4">
        <div className="rounded-[1.1rem] bg-[#fff0f2] p-6">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-[#8c1d40]">
